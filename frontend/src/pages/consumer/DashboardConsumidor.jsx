      ...
      <header className="glass" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <h1 style={{ fontSize: 20, fontWeight: 800, color: D.text, letterSpacing: '-0.5px' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{
                  ...
                  background: isDark ? 'rgba(56,189,248,0.05)' : D.surface,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div className="md:hidden search-md" style={{ flex: 1, maxWidth: 300, marginRight: 8 }}>
              <div style={{ position: 'relative' }}>
                ...
                <input type="text" placeholder="Buscar..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} onKeyDown={handleSearch}
                  style={{ width: '100%', paddingLeft: 32, paddingRight: 10, paddingTop: 7, paddingBottom: 7, background: isDark ? 'rgba(56,189,248,0.05)' : D.surface, border: `1px solid ${D.border}`, borderRadius: 8, color: D.text, fontSize: 12, outline: 'none' }} />
              </div>
            </div>
            ...
            <div style={{ position: 'relative' }}>
              <motion.button
                ...
                style={{
                  padding: '8px', borderRadius: 10, border: `1px solid ${D.border}`,
                  background: notificationsOpen ? 'rgba(56,189,248,0.1)' : 'rgba(56,189,248,0.05)',
                ...
                {notificationsOpen && (
                  <motion.div
                    ...
                    style={{
                      ...
                      border: `1px solid ${D.border}`,
                      borderRadius: 14,
                      boxShadow: isDark ? '0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(56,189,248,0.08)' : '0 8px 32px rgba(0,0,0,0.12)',
                      ...
                      {notifications.length === 0 ? (
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: !n.leida ? (isDark ? 'rgba(56,189,248,0.06)' : 'rgba(56,189,248,0.04)') : 'transparent',
          ...
          <div style={{ maxWidth: 420, position: 'relative' }}>
            ...
            <input type="text" placeholder="Buscar productos, productores..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} onKeyDown={handleSearch}
              style={{
                ...
                background: isDark ? 'rgba(56,189,248,0.05)' : D.surface, border: `1px solid ${D.border}`,
